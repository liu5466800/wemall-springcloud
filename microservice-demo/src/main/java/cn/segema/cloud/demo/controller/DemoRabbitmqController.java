...
public class DemoRabbitmqController {
	...
	public void send() {
		...
		//rabbitMessagingTemplate.convertAndSend("myDirectExhange", "myDirectExhange-myDirectQueue","这是DirectExhange消息");
		amqpTemplate.convertSendAndReceive("myDirectExhange", "myDirectExhange-myDirectQueue", "这是确认消息内容", new MyMessagePostProcessor());
